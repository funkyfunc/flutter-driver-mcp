...
function targetSchema(extras: Record<string, object> = {}, required: string[] = []): Tool["inputSchema"] {
  return {
    type: "object",
    properties: {
...
export const TOOL_DEFINITIONS: Tool[] = [
...

  {
    ...
    inputSchema: {
      ...
      properties: {
        summaryOnly: {
          type: "boolean",
          description: "If true, returns a filtered tree hiding layout clutter (Container, Padding, etc.)",
        },
      },
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        save_path: {
          type: "string",
          description: "Optional path to save the screenshot file (e.g. 'screenshot.png'). If not provided, returns base64.",
        },
        type: {
          type: "string",
...

  {
    ...
    inputSchema: {
      type: "object",
      properties: { target: { type: "string", description: TARGET_DESCRIPTION } },
      required: ["target"],
    },
  },
  {
...

  {
    ...
    inputSchema: {
      type: "object",
      properties: { route: { type: "string", description: "Named route to navigate to (e.g. '/settings')" } },
      required: ["route"],
    },
  },
  {
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: { wifi: { type: "boolean", description: "Enable or disable WiFi" } },
      required: ["wifi"],
    },
  },
...

  {
    ...
    inputSchema: {
      type: "object",
      properties: { lines: { type: "number", description: "Number of lines to read (default 50)" } },
    },
  },
  {
